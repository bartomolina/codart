...
const Learn = () => {
  ...
  return (
    <>
      <Head>
        <title>Learn - CodArt</title>
        <meta name="description" content="CodArt" />
      </Head>
      <div className="mx-auto max-w-6xl sm:px-6 lg:px-8 py-8 text-center">
        <div className="flex flex-row space-x-8">
          <Link
            href={{ pathname: "/learn", query: { minChars: "0",  maxChars: "2000" } }}
            className="rounded-lg py-3 px-8 text-white shadow-md bg-gradient-to-r from-yellow-500 to-red-500 hover:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:ring-offset-2"
          >
          ...
          <Link
            ...
            className="rounded-lg py-3 px-8 text-white shadow-md bg-gradient-to-r from-red-500 to-blue-500 hover:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:ring-offset-2"
          >
          ...
          <Link
            ...
            className="rounded-lg py-3 px-8 text-white shadow-md bg-gradient-to-r from-blue-500 to-green-500 hover:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:ring-offset-2"
          >
